# Tuning — Stage 2: Analyze the inspiration

**Read this before analyzing a scraped inspo.** Feedback the user leaves about how
you *read* a reference post (what you missed, mis-graded, or over-credited) lands here.
The analysis itself is written to the Sheet's **TikTok Inspo Analysis** tab.

## What a good analysis captures
- **What it actually is** — judged from the *pixels of every slide*, not the caption or
  cover keyword. (A "PLAN A/B/C" cover can be a travel guide OR a dating meme — only the
  slides tell you.)
- **Copy / storytelling** — the voice, the sentence rhythm, how the hook pays off slide to
  slide, whether each slide is one complete beat.
- **Hook** — the exact cover line + first-slide promise. Extract it to the **TikTok Hooks**
  tab (general, creator/location-agnostic phrasing — the *mechanism*, not the words).
- **Design** — *you are weak at design; this is where image references matter most.* Note
