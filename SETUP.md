...
| **Google Sheet** — "Project Ana 2.0" | https://docs.google.com/spreadsheets/d/1Wskn2YPWwu3cEBJVTwyYpgM7XXVjJwODLjZVqLgAqWo/edit | The human front-end: a fact tab per character + Dashboard + Connectors + Accounts + Content + Dictionary. GREEN cells = your feedback channel. |
